...
export const login_page_onesurcle = styled.div`
  position: absolute;
  right: 0px;
  top: 0px;
`;
...
export const login_page_twosurcle = styled.div`
  position: absolute;
  bottom: 0px;
  left: 0px;
`;

export const login_box_sign_up = styled.div`
...
export const login_box_sign_up_title = styled.div`
  user-select: none;
...
export const login_box_sign_up_text = styled.div`
  user-select: none;
  width: 250px;
  height: 42.71px;
  margin-top: 10px;
...
export const login_box_info_box = styled.div`
  display: flex;
  flex-direction: column;
  align-items: center;
  width: 770px;
...
export const login_box_info_box_title = styled.p`
...
export const login_box_info_socialLogin_Naver = styled.div`
  margin-left: 25px;
  width: 45px;
  height: 45px;
...
`;
export const login_box_info_socialLogin_Kakao = styled.div`
  width: 45px;
  height: 45px;
...
export const login_box_info_socialLogin_Google = styled.div`
  margin-right: 25px;
  width: 45px;
  height: 45px;
...
export const login_box_info_IdBox = styled.div`
  display: flex;
  align-items: center;
...
export const login_box_info_flex = styled.div`
  display: flex;
  align-items: center;
`;

export const login_box_info_IdIcon = styled.div`
  margin-left: 28px;
  width: 22px;
  height: 22px;
`;

export const login_box_info_IdPlaceholder = styled.p`
  ...
  margin-left: 7px;
`;
export const login_box_info_IdInput = styled.input`
...
`;
export const login_box_info_PasswordInput = styled.input`
  font-size: 25px;
  font-family: "Noto Sans", sans-serif;
...
export const login_box_info_Search_Paswword = styled.p`
  margin-top: 50px;
  margin-bottom: 10px;
...
export const login_box_info_Search_Paswword_line = styled.div`
  width: 220px;
  height: 2px;
