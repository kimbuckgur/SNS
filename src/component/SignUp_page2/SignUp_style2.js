...
export const SignUp_box_info_box_input = styled.input`
...
export const SignUp_box_info_box_button = styled.button`
  cursor: pointer;
  ...
  margin-left: 20px;
`;
export const SignUp_box_info_box_input_long = styled.input`
  margin-top: ${(props) => props.percent};
  padding: 0px;
  padding-left: 20px;
  width: 560px;
